...
module.exports = (robot) ->
  ...
  robot.respond /add (.*): (.*)/i, (msg) ->
    ...
    exec 'cd /app/sooloplopluguaa && git pull', (error, stdout, stderr) ->
      ...
      if error != null
        ...
        if isDuplicate
          ...
          exec 'cd /app/sooloplopluguaa && git add . && git commit -m \"Added new rules\" && git push && git push heroku master', (error, stdout, stderr) ->
            console.log 'stdout: ' + stdout
            console.log 'stderr: ' + stderr
            if error != null
              console.log 'exec error: ' + error
